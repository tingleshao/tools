...
{
   /**
    * \brief Templated Extension of the BaseBuffer class that supports elements arbitrary size
    **/
   template <typename T>
   class ExtendedBuffer : public BaseBuffer
   {
      private: 
      ...
      public:
         ...
         T operator [](size_t index) const   {return ((T*)BaseBuffer::m_buffer.get())[index];};
         /** \brief assigned the index to the value **/
         T & operator [](size_t index) { return ((T*)BaseBuffer::m_buffer.get())[index];};
   };
    ...
    **/
    ...
    {
       bool rc = BaseBuffer::allocate( m_elementSize * elements, resizeFlag );
    ...
    size_t ExtendedBuffer<T>::setElements( T * array, size_t elements, size_t startIndex, bool resizeFlag)
    {
       ...
       //Set data as needed
       size_t bytes = BaseBuffer::setData((uint8_t *)array
    ...
    bool ExtendedBuffer<T>::getElements( T * array, size_t count, size_t startIndex )
    {
       ...
       memcpy( array, BaseBuffer::m_buffer.get(), count * m_elementSize );
       return true;
